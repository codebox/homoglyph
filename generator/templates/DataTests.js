[[prelude]]describe("Homoglyph Search - Data Tests", function () {
        ...
        describe("Homoglyphs of '" + targetChar + "'", function(){
            homoglyphs.forEach(function (c) {
                it("Checking '" + c + "'", function () {
                    ...
                    expect([[search_call]](textContainingHomoglyph, [targetWord])).toEqual([{match: textContainingHomoglyph, word: targetWord, index: 0}]);
                })
            });
        })
    }
